...
# spacy model for similarity checking
...
def send_message(prompt):
    try:
        ...
        # formating with role and content keys
        ...
        full_response = " ".join(response_text).replace("\n", "  \n")  # Join chunks and replace newlines with markdown newlines
...
# Main title
st.markdown("<h1 style='text-align: center; color: green;'>Chat with Agri Master!</h1>", unsafe_allow_html=True)

# Subheader
st.markdown("<h3 style='text-align: center;'>Ask about crop diseases treatment and Cultivation practices</h3>", unsafe_allow_html=True)
